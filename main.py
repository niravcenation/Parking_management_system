...
def two_wheel():
    ...
    can_widget = Canvas(f3, width=1000, height=800, bg="lightgreen")

    l1 = Button(f3, text="Click here for Slot 1", borderwidth=5, relief=RAISED, bg="pink", command=lambda: click_1(1))
    l1.pack()
    l1.place(x=50, y=445)

    l2 = Button(f3, text="Click here for Slot 2", borderwidth=5, relief=RAISED, bg="pink", command=lambda: click_1(2))
    l2.pack()
    l2.place(x=50, y=590)

    l3 = Button(f3, text="Slot 3", borderwidth=5, relief=RAISED, bg="pink", command=lambda: click_1(3))
    l3.pack()
    l3.place(x=410, y=700)

    l4 = Button(f3, text="Slot 4", borderwidth=5, relief=RAISED, bg="pink", command=lambda: click_1(4))
    l4.pack()
    l4.place(x=570, y=700)

    l5 = Button(f3, text="Click here for Slot 5", borderwidth=5, relief=RAISED, bg="pink", command=lambda: click_1(5))
    l5.pack()
    l5.place(x=800, y=445)

    l6 = Button(f3, text="Click here for Slot 6", borderwidth=5, relief=RAISED, bg="pink", command=lambda: click_1(6))
    l6.pack()
    l6.place(x=800, y=590)

    l7 = Button(f3, text="If all slots are booked click here", borderwidth=5, font="TimesNewRoman 20 bold ",
                relief=RAISED, bg="pink", command=lambda: click_1(7))
    l7.pack()
...
def four_wheel():
    ...
    can_widget = Canvas(f2, width=1000, height=800, bg="lightgreen")

    l1 = Button(f2, text="Click here for Slot 1", borderwidth=5, relief=RAISED, bg="pink", command=lambda: click_2(1))
    l1.pack()
    l1.place(x=50, y=490)

    l2 = Button(f2, text="Click here for Slot 2", borderwidth=5, relief=RAISED, bg="pink", command=lambda: click_2(2))
    l2.pack()
    l2.place(x=435, y=700)

    l3 = Button(f2, text="Click here for Slot 3", borderwidth=5, relief=RAISED, bg="pink", command=lambda: click_2(3))
    l3.pack()
    l3.place(x=800, y=490)

    l4 = Button(f2, text="If all slots are booked click here", borderwidth=5, font="TimesNewRoman 20 bold ",
                relief=RAISED, bg="pink", command=lambda: click_2(4))
    l4.pack()
...
def first_page():
    ...
    f1 = Frame()
    f1.configure(bg="lightgreen")
    f1.place(x=0, y=0, width=1000, height=800)

    Label(f1, text="What do you want to park?", font="TimesNewRoman 40 bold", bg="lightyellow", fg="red", borderwidth=10,
          relief=RIDGE, padx=15, pady=15).pack(side=TOP, fill="y", pady=30)

    Button(f1, text="Four Wheeler", font="TimesNewRoman 40 bold", command=four_wheel, bg="blue", fg="white",
...
f0 = Frame()
f0.configure(bg="lightgreen")
f0.place(x=0, y=0, width=1000, height=800)

Label(f0, text="WELCOME TO THE PARKING ZONE", font="TimesNewRoman 20 bold", bg="lightyellow", fg="red", pady=20, padx=20,
      borderwidth=10, relief=RIDGE).pack(side=TOP, pady=40)
Label(f0, text="For Parking Tap the Below Image", font="TimesNewRoman 10 bold", bg="cyan", fg="red", pady=20,
      padx=20,
...
lbl1 = Button(f0, image=photo, command=first_page, borderwidth=15, relief=RIDGE)
lbl1.pack()
